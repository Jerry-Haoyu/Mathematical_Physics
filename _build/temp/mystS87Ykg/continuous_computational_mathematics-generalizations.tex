...
\begin{mystadmonition}{mystAmber}{Fixed Endpoint Assumption}The perturbation $\delta y$ is 0 at endpoints, hence all boundary/surface terms arising from integartion by parts may be ignored.
...
\begin{mystadmonition}{mystAmber}{Elastic Rods}\begin{itemize}
...
\begin{mystadmonition}{mystGreen}{Solution to Problem 0}We need a little lemma(or recall from Calculus I):
\begin{equation}
...
\begin{mystthmproof}{Proof of lemma}{proof-generalizations-1}If we imagine we traverse along a curve $\Gamma$, the accelearation would be:
\begin{equation}
\begin{aligned}
...
\end{mystthmproof}
\end{mystadmonition}
\begin{mystadmonition}{mystGreen}{Solution to Problem 1}(a) Consider the schemetic above. Suppose $y=0$ for $z\in (L -dL,L)$, then
\begin{equation}
\begin{aligned}
