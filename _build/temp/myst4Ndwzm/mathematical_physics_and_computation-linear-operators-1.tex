...
\begin{example}[Unbounded Opeartor]Consider the \textbf{differential operator} $\frac{d}{dx}: C^{\infty}[0,2\pi]\to C^{\infty}[0,2\pi]$
...
\end{example}\paragraph{The Uniform Boundedness Theorem}

\subparagraph{Baire Category Theorem}

\begin{theorem}[Baire Category Theorem]Let $X$ be a \textbf{complete metric space} then:
