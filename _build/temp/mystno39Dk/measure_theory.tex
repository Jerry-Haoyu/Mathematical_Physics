...
\end{mystexercise}
\begin{mystsolution}\mystSolHead{Solution to \ref{Open Set as a Topology}}\begin{enumerate}
...
\end{definition}\begin{mystexercise}\label{exercise-MoIMrRn4Uy}\label{exercise-moimrrn4uy}\mystExHead{h-intervals generate $\mathcal B_{\mathbb{R}}$}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
