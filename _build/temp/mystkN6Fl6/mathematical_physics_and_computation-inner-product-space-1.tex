...
\begin{mystexercise}{$\delta$ is a ring homomorphism}{delta_as_ring_homomorphism}\label{delta_as_ring_homomorphism}Consider $\mathcal T$ and $\mathbb{R}$ as two rings.
...
\begin{mystsolution}{Solution to Exercise~\ref{delta_as_ring_homomorphism}}\begin{enumerate}
...
\end{mystsolution}
\begin{mystexercise}{$\delta^{(1/2)}$}{delta_1over2}\label{delta_1over2}We can define the distribution $\delta^{(1/2)}$  as a fourier transform of $|k|^{1/2}$:
\begin{equation}
...
\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{delta_1over2}}\begin{enumerate}
...
\end{mystcodebox}
\begin{mystthmexample}{}{example-innerproductspace-1}A quick example for $N=4$:
\begin{equation}
\begin{aligned}
4\begin{pmatrix}
p_1 & -p_1 & 0 & 0 \\
...
\begin{mystthmproposition}{}{proposition-innerproductspace-2}The Sturm-Liouville Operator on $[0,1]$ with Dirchlet boundary condition $y(0)=y(1)$ can be discretized as
\begin{equation}
\label{discreteSL}
\begin{aligned}
L=N\begin{pmatrix}
...
\begin{mystthmexample}{-$\frac{d^2}{dx^2}$}{example-innerproductspace-3}We have already seen that the opeartor:
\begin{equation}
...
\begin{mystexercise}{}{exercise-begpygf1jg}\label{exercise-begPyGF1jG}\label{exercise-begpygf1jg}\begin{enumerate}
