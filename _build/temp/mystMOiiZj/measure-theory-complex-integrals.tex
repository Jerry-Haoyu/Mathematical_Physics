...
\begin{definition}[Complex Integral]Let $f:\mathbb{C}\to \mathbb{C}$ be a continous complex function and $\Gamma$ is a smooth path in $\mathbb{C}$, then the limit on the R.H.S exists and we define the L.H.S
...
\end{definition}We can compte the integral by computing two standard real line integrals:
\begin{equation}
