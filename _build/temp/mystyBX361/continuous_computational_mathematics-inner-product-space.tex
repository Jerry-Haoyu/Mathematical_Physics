...
\begin{mystthmlemma}{Outer-product decomposition of the identity operator}{lemma-innerproductspace-1}Let $\{e_{\nu}\}$ be an orthonormal basis for $V$, then:
\begin{equation}
|e_{\nu} \rangle \langle e_{\nu}|=I
\end{equation}

\end{mystthmlemma}
\begin{mystadmonition}{mystGreen}{\emph{Help!} What is happening here?}\textit{Step 1} We first rewrite inner product as a sum of component-component product. In $\mathbb{C}^3$ for instance,
\begin{equation}
\begin{aligned}
