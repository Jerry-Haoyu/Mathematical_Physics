...
\begin{mystexercise}{Open Set as a Topology}{open-set-as-a-topology}\label{Open-Set-as-a-Topology}\label{open-set-as-a-topology}\begin{enumerate}
...
\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{Open-Set-as-a-Topology}}\begin{enumerate}
...
\end{mystthmdefinition}
\begin{mystexercise}{Completeness of $\mathcal M_{\mu^*}$}{completeness-of-mathcal-m_-mu-}\label{Completeness-of-mathcal-M_-mu-}\label{completeness-of-mathcal-m_-mu-}A measure $\mu$ on a $\sigma$-algebra $\mathcal{M}$ is complete if
\begin{equation}
...
\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{Completeness-of-mathcal-M_-mu-}}\begin{mystthmproof}{}{proof-measure-6}Note that $\mu(N)=0\Longrightarrow \mu(N')=0$. $\forall E\subseteq X$, by subadditivity:
\begin{equation}
...
\end{mystthmproof}
\end{mystsolution}
\begin{mystexercise}{}{folland-problem-18-}\label{Folland-Problem-18-}\label{folland-problem-18-}Let $\mathcal{A} \subset \mathcal{P}(X)$ be an algebra, $\mathcal{A}_\sigma$ the collection of countable unions of sets in $\mathcal{A}$, and $\mathcal{A}_{\sigma\delta}$ the collection of countable intersections of sets in $\mathcal{A}_\sigma$. Let $\mu_0$ be a premeasure on $\mathcal{A}$ and $\mu^*$ the induced outer measure.
...
\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{Folland-Problem-18-}}1.This is just the definition of outer measure(namingly, infimum). Note since
\begin{equation}
\mu^*(E)= \inf C
\end{equation}
where
...
\end{mystsolution}
\begin{mystexercise}{}{folland-19}\label{Folland-19}\label{folland-19}Let $\mu^*$ be an outer measure on $X$ induced from a finite premeasure $\mu_0$. If $E \subset X$, define the inner measure of $E$ to be $\mu_*(E) = \mu_0(X) - \mu^*(E^c)$. Then $E$ is $\mu^*$-measurable iff $\mu^*(E) = \mu_*(E)$

\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{Folland-19}}\end{mystsolution}
...
\begin{mystexercise}{Order invariance for Series of Positive Terms}{order-invariance-for-series-of-positive-terms}\label{Order-invariance-for-Series-of-Positive-Terms}\label{order-invariance-for-series-of-positive-terms}\begin{enumerate}
...
\end{mystexercise}
\begin{mystsolution}{Solution to Exercise~\ref{Order-invariance-for-Series-of-Positive-Terms}}\begin{enumerate}
...
\begin{enumerate}[resume]
\item We first make a claim known from calculus:
...
\begin{itemize}
\item $\sup(s_n + t_n) \leq \sup s_n + \sup t_n$
\end{itemize}
...
\end{mystthmdefinition}
\begin{mystexercise}{h-intervals generate $\mathcal B_{\mathbb{R}}$}{exercise-cs8syaay3s}\label{exercise-CS8sYaAy3s}\label{exercise-cs8syaay3s}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
