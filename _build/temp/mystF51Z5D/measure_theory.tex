...
\end{definition}\begin{mystexercise}\label{exercise-Y8gqXlHqG1}\label{exercise-y8gqxlhqg1}\mystExHead{h-intervals generate $\mathcal B_{\mathbb{R}}$}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
