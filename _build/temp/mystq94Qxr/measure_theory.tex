...
\end{definition}\begin{mystexercise}\label{exercise-NTb0UTPUTu}\label{exercise-ntb0utputu}\mystExHead{h-intervals generate $\mathcal B_{\mathbb{R}}$}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
