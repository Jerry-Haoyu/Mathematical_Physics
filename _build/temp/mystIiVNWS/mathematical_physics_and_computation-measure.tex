...
\end{definition}\begin{mystexercise}\label{exercise-x80ENwZQJr}\label{exercise-x80enwzqjr}\mystExHead{h-intervals generate $\mathcal B_{\mathbb{R}}$}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
