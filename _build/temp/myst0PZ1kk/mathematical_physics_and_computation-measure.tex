...
\end{definition}\begin{mystexercise}\label{exercise-yb1bVxe1VD}\label{exercise-yb1bvxe1vd}\mystExHead{h-intervals generate $\mathcal B_{\mathbb{R}}$}Check $H$ is an elementary set and so it generates an algebra $\mathcal A$. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A$ is   $\mathcal B_{\mathbb{R}}$
