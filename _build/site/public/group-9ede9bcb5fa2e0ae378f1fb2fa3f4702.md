...
This analogy is good as long as we  only consider the closedness aspect. A group is fundamentally different(well, the binary operation )however, posses more strucutre:
