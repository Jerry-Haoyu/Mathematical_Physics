...
- Suppose $T$ is **linear and continous**. Then in particular $T$ is continous at $x=0$. We can find a $\delta >0$ such that $\forall x\in B_{\delta}^o(0)$ such that $\forall x\in $
:::