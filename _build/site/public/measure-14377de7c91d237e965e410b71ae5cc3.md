...
:::
The next theorem prevents this by starting with an *algebra* $\mathcal A$ instead of just a plain family of sets $\mathcal E$.  The plain notion of size on $\mathcal E$
