...
2. Try a different discretization with center difference or back difference. (a) Is the resulting matrix $L$ still symmatetric ? (b) Center differencing scheme results in a numerical artifcat, what is it? 
:::
