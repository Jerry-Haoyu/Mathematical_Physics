...
Also, $\frac{dT}{dz}$ is co-linear with our quanitty of interest $#\frac{dT}{dz}=\frac{dT}{ds}\frac{ds}{dz}$$
Therefore:
$$
\boxed{r''(z)= \frac{d^2s}{dz^2}T + \left(\frac{ds}{dz}\right)^2 }
$$
...
1. (LHS) $T=(1,0,y')/ds$, hence $r''(z) = (0,0,y'')$. Hence the cross product is:
   $$
    \frac{1}{ds} (1,0,y')^T \times (0,0,y'')  = \frac{1}{ds}(0,y'',0)^T
   $$
2. (RHS) By orthogonality, we have $$T \times \frac{ds}{dz}\frac{dT}{dz} = \frac{ds}{dz} \frac{dT}{dz} $$. Now using chain rule, $\frac{dT}{dz}=\frac{dT}{ds}\frac{ds}{dz}$ hence the R.H.S becomes:
$$
\frac{dT}{ds}\left(\frac{ds}{dz}\right)^2
$$
The equation becomes:
$$
\frac{1}{ds}(0,y'-y'',0)^T = \frac{dT}{ds}\left(\frac{ds}{dz}\right)^2
$$
:::
:::
