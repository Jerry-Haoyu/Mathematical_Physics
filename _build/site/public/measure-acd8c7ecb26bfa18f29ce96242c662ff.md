...
$$
by reindexing and denote $\delta_j = \frac{\epsilon}{2^{j_k}}$ we have:
$$
\bigcup_{k=1}^n (a_{k},b_{k}+\delta_k)
$$
note that $(a,b]\subset [a,b]\subset \bigcup_{k=1}^n (a_{k},b_{k}+\delta_k) \subset \bigcup_{k=1}^n (a_{k},b_{k}+\delta_k] $
hence by monotonicity, 
$$
b-a= m^*((a,b]) \leq  m^*(\bigcup_{k=1}^n (a_{k},b_{k}+\delta_k])
$$
