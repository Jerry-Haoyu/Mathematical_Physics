...
Equip $C_{2\pi}$ with the iniftity norm to obtain the Banach Space ($C_{2\pi}$, \|\cdot\|_{\infty}). Then show a weaker form of convergence -- **Convergence in Abel's Sense** by introducing
:::
