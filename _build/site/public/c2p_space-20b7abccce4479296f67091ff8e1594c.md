...
Consider a constant-valued series $\sum_k a_k$, the corresponding Abel's summation transform it into a power series $\sum_k a_k r^k$. We say $\sum_k a_k$ converges to 
:::
