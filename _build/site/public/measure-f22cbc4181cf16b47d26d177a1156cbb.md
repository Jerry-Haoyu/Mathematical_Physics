...
$$
is a cover for $E$, furthermore $cB+d=A$. This can be shown since for all $e\in E$, $ce+d\in cE+d$ hence $\exists (a_t, b_t]$ such that $ce+d \in (a_t, b_t]$. Hence $e \in \left( \frac{a_t-d}{c}, \frac{b_t-d}{c}\right]$. 
