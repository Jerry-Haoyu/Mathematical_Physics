...
2. *Stage 3 to 4*: Shrink the domain by restrict to a particular family $\mathcal|_{\mu^*}\subset P(X)$. This gives us *countable additivity* and This is now a **complete measure**
