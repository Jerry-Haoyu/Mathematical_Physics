...
$$
Deonte $L=\sup(s_n + t_n), s=\sup s_n, t = \sup t_n$. We can pick $N_1, N_2$ such that $\sup s_n < s - \epsilon/2, \sup t_n < t - \epsilon /2$. Let $N=\max(N_1,N_2)$ then $\forall n > N$ we have:
$$
