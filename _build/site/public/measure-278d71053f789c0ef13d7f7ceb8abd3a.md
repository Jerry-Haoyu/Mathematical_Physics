...
$$
where $\delta_{j_k} \leq \epsilon / 2^{j_k}$. Denote $c_k = a_{j_k}, d_k = b_{j_k}+\delta_{j_k}$. We have $[a,b]=\bigcup_{k=1}^n (c_k, d_k)$. Note since implies $d_n>b, c_n < a$ since otherwise $\exists $
