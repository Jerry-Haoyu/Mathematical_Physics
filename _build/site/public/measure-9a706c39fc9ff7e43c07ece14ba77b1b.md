...
$$
Let $A=\cup A_j, A_j=(a_j,b_j]$ be an arbitary cover. Consider $A'_j=(a_j,b_j+\frac{\epsilon}{2^j})$,  clearly $[a,b]\subset \cup A'_j $. By compactness, we can pick a finite subcover:
$$
