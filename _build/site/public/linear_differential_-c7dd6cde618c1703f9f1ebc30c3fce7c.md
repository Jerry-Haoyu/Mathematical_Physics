...
\end{pmatrix}
$$
To assemble the matrix for the sum of quadratic forms $\sum_{i=1}^N Np_i(y_{i+1}^2 -2y_{i+1}y_i +y_i^2)$ we can overlap $A_i$ along the diagonal of $L$ with a stride of $1$. 
<!-- 
