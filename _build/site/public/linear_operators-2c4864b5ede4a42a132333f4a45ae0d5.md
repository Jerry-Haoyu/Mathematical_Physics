...
$$
Since $U$ is triangularizable, $\forall j \leq n-1$, $Uv_j\in \langle v_1,...,v_j \rangle$. Now consider $\beta'=\beta \cup \{v\}$, $\lambda v_j $ clealry also lands in $\langle v_1,...,v_j \rangle$. As a result, 
