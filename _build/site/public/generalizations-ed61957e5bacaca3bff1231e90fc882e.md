...
Often, the minimization of the action is subjected to physcial constraint. For instance, in the famous *catenary problem*, we need to fix the length of the hanging chain. 
