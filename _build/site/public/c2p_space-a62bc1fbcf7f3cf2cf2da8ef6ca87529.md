...
$$
For the tail sum, we notice that, by the convergence of the sequence $s_j$, we can pick an $N$ such that $\forall j > N$, $|s_j-c|<\epsilon/2$. Hence:
$$
(1-r)\sum_{j=N+1}^{\infty} |s_j-c|r^j \leq \frac{\epsilon}{2}
$$
