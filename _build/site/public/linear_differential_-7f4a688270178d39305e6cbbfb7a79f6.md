...
### Eigenvalue Problem From Functional Optimization
...
$$
what is the motivation for doing so? It turns out solving the eigenvalue problem is equivalent to optimizing $F(y)$. Consider the problem:
