...
#### Problem 1
The rod is used as a column which supports a compressive load $Mg$ directed along the z axis (which is vertical). Show that when the rod buckles slightly (i.e. bends with both ends remaining on the z axis) the
