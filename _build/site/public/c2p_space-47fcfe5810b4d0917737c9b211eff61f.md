...
The famous Norwegian Mathematician Niels Henrik Abel. Quite a good-looking fella ei? Probably everyone's first encoutner would be **Abel's test** from Calculus, i.e. if $\sum_k a_k$ is convergent, then $\sum_k a_b_k$ is convergent iff $b_k$ is *monotone* and *bounded*.
:::
