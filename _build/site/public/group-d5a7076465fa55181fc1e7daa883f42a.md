...
This analogy is good as long as we  only consider the closedness aspect. A group is fundamentally different(well, firstly the binary operation is deterministic while breeding is probablistic)however, posses more strucutre:
