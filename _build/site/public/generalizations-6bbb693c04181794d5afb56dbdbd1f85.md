...
$$
\widehat{\frac{\delta J}{\delta f}} &= \sum_{n=1}^{\infty} \hat b_n \sin(\omega_n z) \\
&= \sum_{n=1}^{\infty}-(Mg\omega_n^2+YI\omega_n^4)a_n\sin(\omega_n z)
$$
...
\widehat H = 
\begin{pmatrix}
\frac{\partial \hat b_{1}}{\partial a_1} & \frac{\partial \hat b_{1}}{\partial a_2} & \cdots \\
\frac{\partial \hat b_{2}}{\partial a_1} & \frac{\partial \hat b_{2}}{\partial a_2} & \cdots \\
\vdots  & & \ddots \\
\frac{\partial \hat b_{n}}{\partial a_1} & \cdots & \cdots \frac{\partial \hat b_{n}}{\partial a_1} 
\end{pmatrix}
$$
:::