...
$$
- For $\leq$ it suffices to find one cover $A=\{(a_j,b_j]\} $ with $\sum b_j - a_j \leq b-a$. We note $\forall \epsilon > 0$,  $(a-\epsilon/2,b]$ would cover $[a,b]$ and 
$$
...
- For $\geq$ we need to show for all cover $$
:::
