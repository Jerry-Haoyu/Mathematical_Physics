...
\int (\cdot ) dV 
$$
In some sense, this $dV$ is a function $dV:E\to \mathbb{R}$ which computes the volume of $E$ where $E\subset \mathbb{R}$ is the tiny control volume we are interested in.  