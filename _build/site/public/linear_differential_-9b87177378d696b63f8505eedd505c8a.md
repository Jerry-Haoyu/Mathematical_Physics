...
4. We note that the problem $(\Gamma_L, -k)$ is identical to $(\Gamma_2, k)$ after the coordinate transformation $x'=-x$. Since $-k$ reverse the direction the in-comingwave is traversing,
