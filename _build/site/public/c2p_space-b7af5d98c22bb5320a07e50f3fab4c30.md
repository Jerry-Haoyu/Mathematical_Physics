...
$$s_j :=\sum_{k=1}^j a_k r^k$$

Want: $\forall \epsilon >0$, $\exists \delta >0$
 s.t. $\forall r > 1-\delta $ we have $|\lim_{j\to \infty}s_j(r) - c|<\epsilon$. 

First note that, $\lim_{j\to \infty}s_j(r)=c$ for $r=1$ as given by the assumption.
