...
$$
The set is open because it is a countable union of open balls. Threrefore its complement is closed and has measure $. It's left to show that the complement is nowhere dense. Suppose $x\in \overline{\mathbb{R}\setminus A_{\epsilon}}$
:::
