...
$$
Clearly $\mathcal B_x \subseteq \mathcal B'$. Now replace $\mathcal B_x$ by $\bigcup_{B\in \mathcal B_x} B$. We need to show the later is alsoThis is justified by the following claim:
