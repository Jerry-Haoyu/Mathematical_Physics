...
## Fourier Basis $e^{ikt}$ 
**$C_{2\pi}$  is a space of  continuous functions that is $2\pi$-periodic **. This is precisely the space of functions we are going to expand by fourier series. The 
