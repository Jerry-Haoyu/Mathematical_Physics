...
Check $H$ is an elementary set and so it generates an algebra. Furthermore, show that the $\sigma$-algebra generated by $\mathcal A=\mathcal M(H)$ $\mathcal B_{\mathbb{R}}$
:::
