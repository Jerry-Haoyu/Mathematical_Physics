...
This motivates us to define a solution in a weaker sense. Since $a(u,v)=(f,v)$ is a necessary condition of $u$, how about making every $u$ that satisfies this equation a "weak solution"(or g)


We also define the space that our weak solution would reside:
$$
