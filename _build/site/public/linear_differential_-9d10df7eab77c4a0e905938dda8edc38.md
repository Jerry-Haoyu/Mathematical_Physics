...
[^normalization]: Since iterative eigensolvers gives eigenvectors of arbitrary magnitude $v_j=a\sin(j\pi(x))$, we need to normalize properly by 1.Ensure $a>0$ 2. Divide by $\sqrt{\sum y_i^2 h} $