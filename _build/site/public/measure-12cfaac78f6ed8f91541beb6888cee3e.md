...
```{figure} media/outer_measure_of_unit_circle.png [^out_measure_of_unit_circle]
```
...
[^out_measure_of_unit_circle]: How do we compute this? A simple way is to count grid points in the circle: ```{code-cell} julia
