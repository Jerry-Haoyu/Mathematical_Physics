...
\end{cases}
$$
is a cover for $E$, furthermore $cB+d=A$. We consider the positive case first, the negative case follows. Since for all $e\in E$, $ce+d\in cE+d$ hence $\exists (a_t, b_t]$ such that $ce+d \in (a_t, b_t]$. Hence $e \in \left( \frac{a_t-d}{c}, \frac{b_t-d}{c}\right]$.  Now 
$$
