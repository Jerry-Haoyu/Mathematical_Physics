...
:::{attention} Exercise
Remove the masking code snippet(implementing Dirchlet boundary condition) in the naive SL class `SturmLiouville`. What is the resulting eigenvectors? Explain the Result.  
:::
