...
This is the group with elements $\{[0]_n,...,[n-1]_n\}$ being the congruence class modulo $n$. The binary operation is addition between congruence classes which can be proven to be 
:::
