...
:::{attention} Exercise
1. Remove the masking code snippet(which implementing Dirchlet boundary condition) in the naive SL class `SturmLiouville`. What is the resulting eigenvectors? Explain the result.
