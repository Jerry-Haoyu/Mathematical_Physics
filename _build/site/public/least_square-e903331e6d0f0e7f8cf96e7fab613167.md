...
In otherword, we would like $(k,b)$ to be able to predict $y$ based on $x$ that best adhere to the relationship implied by the dataset $\mathcal D$. The error of this predictor 
