...
$$
\delta[f\phi] = f(0)\delta[\phi] \Longrightarrow \delta[f(-g')] = f(0)\delta[-g'] = f(0)\delta'(g)
$$
where the last equality used the definition of distribution derivative. 
Now we show that $\delta[f'g]+\delta'[fg]=f(0)\delta'(g)$. We use ring homomorphism property 
