...
:::{exercise}
Prove directly from the definition of Lebesgue outer measure 𝑚∗
that 𝑚∗
([𝑎, 𝑏]) =
𝑏 − 𝑎. (Here 𝑚∗
is officially defined as in the textbook using h-intervals (𝑎, 𝑏].) (The
inequality ≤ is easy; for ≥ use compactness.)
:::
