...
The famous Norwegian Mathematician Niels Henrik Abel 
:::
...
Now:
$$
\left|\lim_{k\to \infty}s_j - c\right| &= \left|\lim_{k\to \infty}\sum_{j=1}^k (\textcolor{brown}{s_j}-\textcolor{pink}{s_{j-1})}r^j - c\right| \\
&= 
\left|\lim_{k\to \infty}\sum_{j=1}^k s_j -  \lim_{k\to \infty}\sum_{j=1}^{k-1} s_j - c\right| 
$$
:::
