...
Let $X$ any metric space, the $\sigma$-algebra genereated by the family of open sets in $X$ is called the **Borel $\sigma$-algebra**
:::

:::{exercise} 
Check $H$ is an elementary set and so it generates an algebra. Furthermore, show that this algebra is 
:::
