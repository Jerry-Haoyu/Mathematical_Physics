...
- Suppose $T$ is **linear and continous**. Then in particular $T$ is continous at $x=0$. We can find a $\delta >0$ such that $\|x\| < \delta \Rightarrow \|T(x)\| < 1$. Now to control arbitrary $x\in X$, 
:::