...
:::{solution} 1dscat
Fix a $k$. Consider $\Pi_1$. Form the Wronskian in $L$:
...
$$
W_L &= (-ik)\cancel{-ikr_L\exp(-2ikx) + ikr_L\exp(2ikx)}+ikr_L^2  \\
&-[ik\cancel{-ikr_K\exp(-2ikx)+ikr_L\exp(2ikx)}-ikr_L^2]  \\
&= 2ik(r_L^2-1)
$$
...
\end{vmatrix} = -2ikt_L^2
$$
Since we would expect $W_R=W_L=0$, hene
