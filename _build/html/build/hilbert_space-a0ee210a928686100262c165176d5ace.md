...
$$
By Bessel's inequality, we know $\sum_{j}\left| \langle x, u_{\alpha_j} \rangle \right|^2$ converges. This implies[^convergent_series_and_tail] the tail can be made arbitarily small, i.e., $\forall \epsilon >0$, \exists $N$
$$
