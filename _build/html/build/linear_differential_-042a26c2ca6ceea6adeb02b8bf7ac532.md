...
4. We note that the problem $(\Gamma_1, -k)$ is identical to $(\Gamma_2, k)$ after the coordinate transformation $x=-x$($-k$ reverse the direction the wave is traversing). Consequently, we have two basis in $L$:
$$
