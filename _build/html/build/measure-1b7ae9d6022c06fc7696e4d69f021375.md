...
- $\boxed{\textbf{Cliam}}$ The union of arbitrary family of open intervals containing $x\in \mathbb{R}$  $$\bigcup_{B\in \mathcal B_x} B\in \{(c,d): c,d\in \mathbb{R}\cup \{\infty, -\infty\}\}$$
:::
