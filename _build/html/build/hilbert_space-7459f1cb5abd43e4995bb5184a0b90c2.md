...
By Bessel's inequality, the series converge hence
$$
...
&= \sum_{n}^m \left| \langle x, u_{\alpha_k} \rangle \right|^2 [^generalized_pythagorean]
$$
:::
...
$$
In particular, if we take only two vectors $a \perp b$, this becomes the Pythagorean's Theorem in middle school
