...
The question would be, when can we find such a function. Trivially we can obtain such property by sending every $A$ to $0$. However, for more practical purposes, we would like nic 
