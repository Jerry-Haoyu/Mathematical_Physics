...
Now we have an algebra $\mathcal A$ where elements of the algebra has an elementary decomposition to h-intervals $(a_j,b_j]$, which is equipped with size $b_j-a_j$.