...
- The later can be shown using (2). $\mathcal M(\mathcal B)$ contains all countable unions of open intervals $\mathcal B$ while $\mathcal T(\mathcal B)$ contains arbitrary union. (2) bridges the gap by claiming t
:::
