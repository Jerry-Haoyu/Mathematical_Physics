...
4. We note that the problem $(\Gamma_1, -k)$ is identical to $(\Gamma_2, k)$ after the coordinate transformation $x=-x$ reverse the direction the in-comingwave is traversing,
