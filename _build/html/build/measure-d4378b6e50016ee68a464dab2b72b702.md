...
Here is a quick numerical demo for approximating a unit circle with squares on a grid. The resolution $n$ is defined as the number of intervals  that divides $(0,1)$ to $n$ intervals. 
