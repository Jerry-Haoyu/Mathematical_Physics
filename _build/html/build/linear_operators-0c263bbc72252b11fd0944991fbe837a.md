...
:::{prf:proof}
- Suppose $T$ is linear and continous, $\forall x_0 \in X$, $\forall \epsilon > 0$, consider the open ball around $x_0$ with radius $\epsilon$. Any element in the ball can be written as $x$
T(B_{\epsilon}^o)
$$
:::