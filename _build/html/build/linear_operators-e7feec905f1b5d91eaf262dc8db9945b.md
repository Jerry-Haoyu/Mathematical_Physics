...
:::{prf:proof}
- Suppose $T$ is linear and bounded, $\forall x_0 \in X$, $\forall \epsilon > 0$, consider the open ball around $x_0$ with radius $\epsilon$ $B_{\epsilon}^o$. Then $\forall x\in $:
$$
 \|T(x)-T(x_0)\| &= \|T(x-x_0)\| \\
&\leq C\|(x-x_0)\|
$$
Now to make $C\|x-x_0\|<\epsilon$, we need $\|x-x_0\|<\frac{\epsilon}{C}$
:::