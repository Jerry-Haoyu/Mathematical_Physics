...
$$
\left \| \sum_{n}^m \langle x, u_{\alpha_j} \rangle u_{\alpha_j} \right \|^2 &= \left\langle \sum_{n}^m  x, u_{\alpha_j} \rangle u_{\alpha_j}, \sum_{n}^m  \langle x, u_{\alpha_k} \rangle u_{\alpha_k} \right\rangle  \\
&=
$$
:::
