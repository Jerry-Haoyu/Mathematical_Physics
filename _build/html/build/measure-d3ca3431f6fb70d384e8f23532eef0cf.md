...
:label: Order invariance for Series of Positive Terms 
...
:::{solution} Order invariance for Series of Positive Terms 
1. We first make a claim 
$$
\sum_{j\in \mathbb{N}}a_j = \sup_J \sum_{j\in J} a_j
$$
where $J\subset \mathbb{N}, |J|<\infty$. It is trivial that 
$\sum_{j\in \mathbb{N}} a_j  \leq \sup \sum_{j\in J} a_j $ since 
$$
\sum_{j=1}^N a_j \leq \sup \sum_{j\in J} a_j 
$$
and taking the limit get as desired.
:::
