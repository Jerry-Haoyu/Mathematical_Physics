...
$$
1. *Stage 1 to 2*: Create a notion of size on arbitrary sets $A\subset P(X)$ by approximating them using "building blocks"$(A\in \mathcal E)$ which has a notion of size $|\cdot |$. This scarifices additivity and 
2. *Stage 2 to 3*: 
