...
- Suppose $T$ is **linear and continous**. Then in particular $T$ is continous at $x=0$:
$\forall \epsilon > 0$, $\exists \delta > 0$ such that $\forall x \in B_{\delta}^o(0)=T(x)\in \in B_{\epsilon}^o(T(0))$
:::