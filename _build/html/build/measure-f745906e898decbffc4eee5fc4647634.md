...
Now we have an algebra $\mathcal A$ where elements of the algebra $A\in \mathcal A$ has an elementary decomposition to h-intervals $(a_j,b_j]$, which is equipped with a notion of size $b_j-a_j$.