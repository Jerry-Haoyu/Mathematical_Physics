...
$$
\left \| \sum_{n}^m \langle x, u_{\alpha_j} \rangle u_{\alpha_j} \right \|^2 &= \langle \langle \sum_{n}^m x, u_{\alpha_j} \rangle u_{\alpha_j}, \langle x, u_{\alpha_k} \rangle u_{\alpha_k} \rangle  \\
&=
$$
:::
