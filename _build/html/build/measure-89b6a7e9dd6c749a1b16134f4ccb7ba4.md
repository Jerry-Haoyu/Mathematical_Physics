...
2. *Stage 2 to 3*: Shrink the domain by restrict to a particular family $\mathcal|_{\mu^*}\subset P(X)$. This gives us *countable additivity* and $\mu$ is now a **complete measure**

:::{prf:example} 
Concretely, think $\mathcal E$ as the set of all rectangles in $\mathbb{R}^2$:
:::
