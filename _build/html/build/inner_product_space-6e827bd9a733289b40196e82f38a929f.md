...
## Exercises
:::{exercise} $T'$ as a Module
:label: dual_as_module

Let $\mathcal T$ be the space of test functions. Let $f\in \mathcal T$. Denote $f(x)\delta(x)\in \mathcal T'$ as the linear functional:
$$
f\delta: g \mapsto  \delta[gf]
$$
In otherword, for any $g\in \mathcal T'$, it is first multiplied by $f\in \mathcal T'$ before passing into $\delta$. Prove that
:::{prf:proposition}
$$
...
%Straight Lines [id:da9967503963778961] 
\draw    (148,80) -- (251,80) ;
\draw [shift={(253,80)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da05749621909420377] 
\draw    (134,92.33) -- (134,140.33) ;
\draw [shift={(134,142.33)}, rotate = 270] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da513088072039465] 
\draw    (147,158.33) -- (251,158.66) ;
\draw [shift={(253,158.67)}, rotate = 180.18] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da30231511514024445] 
\draw    (279,93.33) -- (279,141.33) ;
\draw [shift={(279,143.33)}, rotate = 270] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Rectangle [id:dp3533323465467816] 
\draw  [draw opacity=0][fill={rgb, 255:red, 194; green, 158; blue, 249 }  ,fill opacity=0.36 ] (94,43) -- (202,43) -- (202,187.67) -- (94,187.67) -- cycle ;
%Shape: Rectangle [id:dp3338950218632645] 
\draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.28 ] (202,43) -- (313,43) -- (313,187.67) -- (202,187.67) -- cycle ;

% Text Node
\draw (181,53.4) node [anchor=north west][inner sep=0.75pt]    {$\delta \in \mathcal{T} \ '$};
% Text Node
\draw (128,70.4) node [anchor=north west][inner sep=0.75pt]    {$g$};
% Text Node
\draw (264,71.4) node [anchor=north west][inner sep=0.75pt]    {$\delta [ g]$};
% Text Node
\draw (106.5,103.4) node [anchor=north west][inner sep=0.75pt]    {$f\ \cdot $};
% Text Node
\draw (122,150.4) node [anchor=north west][inner sep=0.75pt]    {$fg$};
% Text Node
\draw (182,136.4) node [anchor=north west][inner sep=0.75pt]    {$\delta \in \mathcal{T} \ '$};
% Text Node
\draw (231.5,105.4) node [anchor=north west][inner sep=0.75pt]    {$f( 0) \ \cdot $};
% Text Node
\draw (255,151.4) node [anchor=north west][inner sep=0.75pt]    {$f( 0) \delta [ g]$};
% Text Node
\draw (113,52.4) node [anchor=north west][inner sep=0.75pt]    {$\mathcal{T}$};
% Text Node
\draw (293,50.4) node [anchor=north west][inner sep=0.75pt]    {$\mathbb{R}$};
...
$$
:::
where $f(0)\delta(x)$ represent the functional:
$$
f(0)\delta : g \mapsto f(0)\delta[g]
$$
In otherword, multiplies the output of the functional $\delta[g]$ by a real number $f(0)$,
:::
:::{solution} dual_as_module
:::
